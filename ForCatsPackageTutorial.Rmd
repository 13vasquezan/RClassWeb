...
Categoical variables deal with qualitative data and have have an infinite number or values (i.e. hair color, location, ethnicity) vereses quantitative data that is on a continuious scale (i.e. 2,3,4). 
...
It is important to note a few things before using the Forcats package. First, this package works with categorical data in the form of factors. You can check what type of class your variable is with the function **class()**. To use Forcats, you should change your variable to a factor with the function **as.factor()** or **factor()**. 

...
It is important to note a few things before using the Forcats package. First, this package works with categorical data in the form of factors. You can check what type of class your variable is with the function class(). To use forcats, you should change your variable to a factor with the function as.factor(). 
...
This allows you to change the location or level of your factor
```{r}
...
This allows you to reorder your factors by using another variable.
```{r}
library(forcats)
library(dplyr)
glimpse(starwars)

...
```
 when you add --- that makes a new page when you do - that makes bullet point  echo false make the code not show on figure
 
 p h1 h2 div will have you edit the size shape of words in html code add it to css file
 
 kniter:: include graphics(look for picture and itll be on slides)
 
 pull-left[] or pull right to make columns
 
 use -- for adding things incrementally
???
...
-You will first need to install the package forcats

-This will also download indicies that will be used under the forcats umbrella
---

# Hello World

Install the **forcats** package from [Github](https://github.com/yihui/xaringan):
